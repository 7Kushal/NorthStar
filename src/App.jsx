...
export default function App() {
  ...
  const selectAccount = id => {
    switchAccount(id);
    setTradeModal(false); setPlanModal(null); setReviewTrade(null); setNoteTrade(null); setElefinModal(false);
  };
...
function Journal({ trades, sessions, onAdd, onReview, onAddNote, onDelete }) {
...
function JournalDayPanel({ date, trades, sessions, onClose, onAdd, onReview, onAddNote, onDelete }) {
