...
function EquityPanel({ trades, start, theme }) {
  ...
  const trendColor = closingBalance > openingBalance ? '#20c997' : closingBalance < openingBalance ? '#ef6673' : '#4d83b3';
